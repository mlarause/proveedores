<div class="tab-pane fade" id="pills-seccion2" role="tabpanel"
                            ...
                            <!-- Formularios a subir -->
                            <div class="col-md-12">
                                <label for="formularios" class="form-label">Los formularios deben enviarse con firma certificada para ser válidos "Nota el formulario FR.GS.15 Visita de seguridad asociado de negocio no necesita firma certificada" <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
