  <!-- Sesión 13: Referencias comerciales -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="alert alert-warning">
                <i class="fas fa-exclamation-circle"></i> Nota: Debe completar al menos dos
                referencias comerciales completas.
            </div>

            <!-- Referencia estática (NO se puede eliminar) -->
            <div class="row g-3 referencia13 border rounded p-3 mb-3 mt-4 position-relative">
                <!-- Pregunta 78 -->
                <div class="col-md-12">
            ...
            <!-- Aquí se agregan las referencias dinámicas -->
            <div id="contenedor-referencias13"></div>

            <button type="button" class="btn btn-secondary mt-3" onclick="agregarReferencia13()">Agregar otra referencia comercial</button>
        </div>
    </div>
