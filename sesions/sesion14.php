            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    <label for="gestion_calidad" class="form-label">83. ¿Dispone de un sistema
                        de
                        gestión de calidad certificado? <span class="text-danger">*</span></label>
                    <select class="form-select" id="gestion_calidad" name="certificaciones[gestion_calidad]" required
                    ...
                    <div id="otro_gestion_calidad" style="display: none;" class="mt-2">
                        <input type="text" class="form-control" name="certificaciones[otro_gestion_calidad]"
...
<div class="col-md-12">
    <label for="seguridad_suministro" class="form-label">84. ¿Dispone de un
        ...
        de Gestión de seguridad de la cadena de suministro certificado? <span
            class="text-danger">*</span></label>
    <select class="form-select" id="seguridad_suministro" name="certificaciones[seguridad_suministro]"
        required onchange="toggleOtroCampo(this, 'otro_seguridad_suministro')">
        <option value="" selected disabled>Seleccione...</option>
        <option value="SI">SI</option>
        <option value="NO">NO</option>
        <option value="N/A">N/A</option>
    ...
    <div id="otro_seguridad_suministro" style="display: none;" class="mt-2">
        <input type="text" class="form-control" name="certificaciones[otro_seguridad_suministro]"
            placeholder="Especifique cual">
    </div>
</div>
...
<div id="campos_certificado_calidad_84" style="display:none;">
            ...
            id="fecha_vigencia_calidad_84">
                ...
                <div class="col-md-12">
                    <label for="operador_economico" class="form-label">85. ¿Cuenta con
                        certificación
                        de Operador Económico Autorizado? <span class="text-danger">*</span></label>
                    <select class="form-select" id="operador_economico" name="certificaciones[operador_economico]"
                        required>
                        <option value="" selected disabled>Seleccione...</option>
                        <option value="SI">SI</option>
                        <option value="NO">NO</option>
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select" id="sistema_sarlaft" name="certificaciones[sistema_sarlaft]" required
                    ...
                    <div id="otro_sistema_sarlaft" style="display: none;" class="mt-2">
                        <input type="text" class="form-control" name="certificaciones[otro_sistema_sarlaft]"
                            placeholder="Especifique cual">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select" id="licencias_ambientales" name="certificaciones[licencias_ambientales]"
                        required onchange="toggleOtroCampo(this, 'otro_licencias_ambientales')">
                        <option value="" selected disabled>Seleccione...</option>
                        <option value="SI">SI</option>
                        <option value="NO">NO</option>
                        <option value="N/A">N/A</option>
                    ...
                    <div id="otro_licencias_ambientales" style="display: none;" class="mt-2">
                        <input type="text" class="form-control" name="certificaciones[otro_licencias_ambientales]"
                            placeholder="Especifique cual">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <label for="seguridad_salud" class="form-label">89. ¿Cuenta con un sistema
                        ...
                        <span class="text-danger">*</span></label>
                    <select class="form-select" id="seguridad_salud" name="certificaciones[seguridad_salud]" required
                    ...
                    <div id="otro_seguridad_salud" style="display: none;" class="mt-2">
                        <input type="text" class="form-control" name="certificaciones[otro_seguridad_salud]"
                            placeholder="Especifique cual">
                    </div>
                </div>
                ...
                <div class="col-md-12" id="avance_ss_group" style="display:none;">
                    <label for="avance_ss" class="form-label">90. Indicar % Avance o N/A <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="avance_ss" name="certificaciones[avance_ss]">
                </div>
                ...
                <div class="col-md-12">
                    <label for="calidad_laboratorios" class="form-label">91. ¿Cuenta con un
                        ...
                        de gestión de calidad para laboratorios bajo la norma vigente? <span
                            class="text-danger">*</span></label>
                    <select class="form-select" id="calidad_laboratorios" name="certificaciones[calidad_laboratorios]"
                        required onchange="toggleOtroCampo(this, 'otro_calidad_laboratorios')">
                        <option value="" selected disabled>Seleccione...</option>
                        <option value="SI">SI</option>
                        <option value="NO">NO</option>
                        <option value="N/A">N/A</option>
                    ...
                    <div id="otro_calidad_laboratorios" style="display: none;" class="mt-2">
                        <input type="text" class="form-control" name="certificaciones[otro_calidad_laboratorios]"
                            placeholder="Especifique cual">
                    </div>
                </div>
    ...
    <div class="d-flex justify-content-between mt-4">
        <button type="button" class="btn btn-secondary" onclick="mostrarSeccion(13)">Anterior</button>
        <button type="button" class="btn btn-primary" onclick="irASeccion15Desde14()">Siguiente</button>
    </div>
</div>